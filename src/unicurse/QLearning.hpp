...
public:
    ...
    void save(const std::string & filename)
    {
        ...
        fout << m_numStates << " " << m_numActions << " " << m_alpha << " " << m_gamma << " " << m_initialQ << " " << m_updates << " " << m_visited << " \n";
    ...
    // Just save the header and Q table (not N or P)
    void savePartial(const std::string & filename) {
        std::ofstream fout(filename);
        fout << m_numStates << " " << m_numActions << " " << m_alpha << " " << m_gamma << " " << m_initialQ << " " << m_updates << " " << m_visited << " \n";
    ...
    void load(const std::string & filename)
    {
        ...
        fin >> m_numStates >> m_numActions >> m_alpha >> m_gamma >> m_initialQ >> m_updates >> m_visited;
...
if (m_maxActions.size() > 1) {
cerr << "maxQ: " << maxQ << endl;
cerr << "m_maxActions.size(): " << m_maxActions.size() << endl;
}
